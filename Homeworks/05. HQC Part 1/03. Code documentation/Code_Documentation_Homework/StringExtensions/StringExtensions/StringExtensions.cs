namespace StringExtensions
{
    ...
    /// <summary>
    /// The class extends the String class as it adds different methods
    /// </summary>
    public static class StringExtensions
    {
        /// <summary>
        /// Converts string to byte array, compute the hash, 
        /// format to a hexadecimal string and return a hexadecimal string.
        /// </summary>
        /// <param name="input">The string which has to be converted.</param>
        /// <returns>String as hex string</returns>
