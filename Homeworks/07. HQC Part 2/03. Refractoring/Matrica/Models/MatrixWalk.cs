...
namespace GameFifteen.Models
{
    ...
    {
        public static void StartMatrixWalk(int cellsNumber, ILogger logger)
        {
            if (logger == null)
            {
            ...
            if (cellsNumber < 1 || cellsNumber > 100)
            {
                throw new OverflowException("Cell number must be less than 100 and more than 1");
            }
